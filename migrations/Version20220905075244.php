 ...
 */
final class Version20220905075244 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, permission_id INT NOT NULL, name VARCHAR(255) NOT NULL, active TINYINT(1) NOT NULL, short_desc VARCHAR(255) DEFAULT NULL, full_desc LONGTEXT DEFAULT NULL, url VARCHAR(255) DEFAULT NULL, dpo VARCHAR(255) DEFAULT NULL, technical_contact VARCHAR(255) NOT NULL, commercial_contact VARCHAR(255) NOT NULL, INDEX IDX_C7440455FED90CCA (permission_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE permission (id INT AUTO_INCREMENT NOT NULL, read_resa TINYINT(1) NOT NULL, edit_resa TINYINT(1) NOT NULL, remove_resa TINYINT(1) NOT NULL, read_payment TINYINT(1) NOT NULL, edit_payment TINYINT(1) NOT NULL, manage_drinks TINYINT(1) NOT NULL, add_sub TINYINT(1) NOT NULL, edit_sub TINYINT(1) NOT NULL, remove_sub TINYINT(1) NOT NULL, manage_schedules TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE client ADD CONSTRAINT FK_C7440455FED90CCA FOREIGN KEY (permission_id) REFERENCES permission (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client DROP FOREIGN KEY FK_C7440455FED90CCA');
